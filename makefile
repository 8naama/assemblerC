assembler: main.o macro.o firstScan.o secondScan.o dataStructures.o filesGenerator.o
	gcc -pedantic -ansi -Wall -g main.o macro.o firstScan.o secondScan.o dataStructures.o filesGenerator.o -o assembler
